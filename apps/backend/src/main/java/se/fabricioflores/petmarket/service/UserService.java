...
public class UserService {
   ...
   */
  public TokenResDto login(LoginCredentials credentials) {
    ...
    return jwtProvider.generateToken(new UserDto(user.getId(), user.getUsername(), user.getFirstname(), user.getLastname()));
  }
